  ...
  {#if showCropModal}
      <div class="custom-modal-overlay">
        <div class="custom-modal crop-modal">
          ...
          <div class="sub-panel mt-10 crop-adjustments">
            <p class="sub-label">Logo Controls</p>
            <label>
              Size
              <input type="range" min="10" max="36" step="1" bind:value={logoSizePercent} />
              <span class="range-value">{logoSizePercent}%</span>
            </label>
            <label class="mt-10">
              Opacity
              <input type="range" min="15" max="100" step="1" bind:value={logoOpacityPercent} />
...
<style>
  ...
  .custom-modal-overlay {
    ...
    display: flex; justify-content: center; align-items: flex-start; z-index: 10000;

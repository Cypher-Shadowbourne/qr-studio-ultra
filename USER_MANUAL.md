...
3. **Select Shapes:**
   - **Main Shape:** Choose between *Square*, *Circle*, *Rounded*, or *Diamond* for the data modules.
   - **Eye Shape:** Customize the three large squares (eyes) in the corners. Options include *Square*, *Circle*, *Rounded*, or *Diamond*.
...
3. **Troubleshooting Save Issues:**
   ...
   - *Current Version Note:* We are working on adding a custom folder picker for even more control over your saves.

---

## 4. Barcode Scanning
The app includes a built-in scanner to read existing QR codes.

1. Navigate to the **Scanner** tab.
2. Grant camera permissions if requested.
3. Point your camera at a QR code.
4. The app will automatically detect the data and provide options to open links or copy text.
...
*Version: 1.0.0*
*Developer: Paul Bess / Cypher Studio*
